...
export const getUsersTransaction = async (req, res) => {
    try {
        ...
        logger.info('TransactionController', 'Fetching user transactions', { accountId });
        ...
        logger.success('TransactionController', `Retrieved ${transactions.length} transactions`, { accountId });
        logger.db('FIND', 'Transactions', { accountId, count: transactions.length });
